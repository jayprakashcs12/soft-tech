...
const Career = () => {
    ...
    let descriptions = [
        ...
        {   
            tabTitle: "As a MERN Stack Developer at our SoftTech company, you'll be instrumental in developing dynamic and responsive web applications using MongoDB, Express.js, React.js, and Node.js technologies. Collaborating closely with our product development team, you'll have the opportunity to contribute to the creation and improvement of innovative digital solutions that meet user requirements. If you possess a strong passion for web development, proficiency in JavaScript, we eagerly await your application.",
            ...
            tabRequirements:"The ideal candidate will possess a Bachelor's degree in Computer Science, Software Engineering, or a related field (or equivalent work experience). We are seeking a talented MERN (MongoDB, Express.js, React.js, Node.js) Developer to join our team. Strong analytical and problem-solving skills are essential, with a proven ability to troubleshoot and debug complex issues. If you are passionate about crafting high-quality software solutions in a collaborative environment, we encourage you to apply."
        },
        {
            tabTitle: "Collaborating closely with our SoftTech company, you'll be contribute to the advancement of robust data management systems that align with organizational requirements. As a SQL Developer within our dynamic team, you will be instrumental in the design, development, and optimization of database solutions. If you possess a strong understanding of SQL and database management systems, along with a passion for creating efficient and scalable data solutions, we encourage you to apply.",
